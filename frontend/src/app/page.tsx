...
export default function Home() {
  ...
  return <main className="min-h-screen">
    ...
    <section className="border-b border-white/[.07]"><div className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-12"><div className="min-w-0 max-w-3xl"><div className="mb-4 text-xs font-semibold uppercase leading-5 tracking-[.14em] text-emerald-300 sm:tracking-[.16em]">Bandit + Semgrep · Contextual AI optional</div><h1 className="break-words text-3xl font-semibold leading-[1.08] tracking-[-.035em] text-white sm:text-balance sm:text-5xl">AI-Assisted Pull Request<br className="hidden sm:block"/> <span className="text-slate-400">Security Analysis</span></h1><p className="mt-4 max-w-2xl text-base leading-7 text-slate-400">Review GitHub pull requests using static analysis, cross-scanner normalization, and contextual security reasoning.</p></div>
    ...
    <footer className="border-t border-white/[.07]"><div className="mx-auto flex max-w-7xl flex-col gap-2 px-5 py-8 text-xs text-slate-600 sm:flex-row sm:items-center sm:justify-between sm:px-8"><p>SentinelReview · Deterministic security analysis</p><p>Scanner results require human review.</p></div></footer>
  </main>;
}
